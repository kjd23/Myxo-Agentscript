...
import { getDirectionVector, mod, randomFloat, randomFloat2, degreesToRadians, dotProduct, randomNormal } from '../src/utils.js' // Import specific functions
...
export default class SlimeMoldModel extends Model {
    ...
    const testTurtle = this.turtles[0]
    ...
    this.turtles.ask((turtle, turtleIndex) => {
        ...
        // let x= util.randomFloat2(-this.radius, this.radius);
    ...
    step() {
        ...
        const turtleOppositeHeading = util.mod(turtle.heading + 180, 360)
            ...
            let q = 10 // cooperativity
            let u_c = 330//350//260//3.05 * this.meanNumb // change // lowering this thershold will increase cooperativty, lowering reversal rate (try 350, lower 300s)
